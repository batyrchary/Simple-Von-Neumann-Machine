...
public class Q17 
{
    ...
    public static void main(String[] args) 
    {
        ...
        SparkConf sparkConf = new SparkConf().setAppName("Q17")
...
////////////////////////////////////
        //from each line finds retweets, puts into list, finally filters out distinct mentions      
        JavaRDD<String> words = lines
                .flatMap(new FlatMapFunction<String, String>() {
                    public Iterator<String> call(String s) 
                    {
  
                    	Pattern pattern = Pattern.compile("RT\\s*@\\w+");
